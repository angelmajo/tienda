...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { descripcion: @producto.descripcion, imagen_url: @producto.imagen_url, precio: @producto.precio, titulo: @producto.titulo }
    end
  ...
  test "should update producto" do
    put :update, id: @producto, producto: { descripcion: @producto.descripcion, imagen_url: @producto.imagen_url, precio: @producto.precio, titulo: @producto.titulo }
    assert_redirected_to producto_path(assigns(:producto))
  end
